...
type Config struct {
	...
	DpiBypassEnabled bool  `protobuf:"varint,14,opt,name=dpiBypassEnabled,proto3" json:"dpiBypassEnabled,omitempty"` // Enable DPI bypass fragmentation
	DpiFragmentSize  int32 `protobuf:"varint,15,opt,name=dpiFragmentSize,proto3" json:"dpiFragmentSize,omitempty"`   // Fragment size in bytes (default: 15360 = 15KB)
	DpiFragmentDelay int32 `protobuf:"varint,16,opt,name=dpiFragmentDelay,proto3" json:"dpiFragmentDelay,omitempty"` // Delay between fragments in milliseconds
	DpiRandomSize    bool  `protobuf:"varint,17,opt,name=dpiRandomSize,proto3" json:"dpiRandomSize,omitempty"`       // Use random fragment sizes
	DpiMinSize       int32 `protobuf:"varint,18,opt,name=dpiMinSize,proto3" json:"dpiMinSize,omitempty"`             // Minimum random size (default: 10KB)
	DpiMaxSize       int32 `protobuf:"varint,19,opt,name=dpiMaxSize,proto3" json:"dpiMaxSize,omitempty"`             // Maximum random size (default: 20KB)
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_transport_internet_splithttp_config_proto_rawDesc = "" +
	...
	"\x10hKeepAlivePeriod\x18\x06 \x01(\x03R\x10hKeepAlivePeriod\"\xc4\b\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x10dpiBypassEnabled\x18\x0e \x01(\bR\x10dpiBypassEnabled\x12(\n" +
	"\x0fdpiFragmentSize\x18\x0f \x01(\x05R\x0fdpiFragmentSize\x12*\n" +
	"\x10dpiFragmentDelay\x18\x10 \x01(\x05R\x10dpiFragmentDelay\x12$\n" +
	"\rdpiRandomSize\x18\x11 \x01(\bR\rdpiRandomSize\x12\x1e\n" +
	"\n" +
	"dpiMinSize\x18\x12 \x01(\x05R\n" +
	"dpiMinSize\x12\x1e\n" +
	"\n" +
	"dpiMaxSize\x18\x13 \x01(\x05R\n" +
	"dpiMaxSize\x1a:\n" +
