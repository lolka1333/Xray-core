...
type Config struct {
	...
	DpiBypassEnabled bool  `protobuf:"varint,7,opt,name=dpiBypassEnabled,proto3" json:"dpiBypassEnabled,omitempty"` // Enable DPI bypass fragmentation
	DpiFragmentSize  int32 `protobuf:"varint,8,opt,name=dpiFragmentSize,proto3" json:"dpiFragmentSize,omitempty"`   // Fragment size in bytes (default: 15360 = 15KB)
	DpiFragmentDelay int32 `protobuf:"varint,9,opt,name=dpiFragmentDelay,proto3" json:"dpiFragmentDelay,omitempty"` // Delay between fragments in milliseconds
	DpiRandomSize    bool  `protobuf:"varint,10,opt,name=dpiRandomSize,proto3" json:"dpiRandomSize,omitempty"`      // Use random fragment sizes
	DpiMinSize       int32 `protobuf:"varint,11,opt,name=dpiMinSize,proto3" json:"dpiMinSize,omitempty"`            // Minimum random size (default: 10KB)
	DpiMaxSize       int32 `protobuf:"varint,12,opt,name=dpiMaxSize,proto3" json:"dpiMaxSize,omitempty"`            // Maximum random size (default: 20KB)
...
func (x *Config) GetDpiBypassEnabled() bool {
	if x != nil {
		return x.DpiBypassEnabled
	}
	return false
}

func (x *Config) GetDpiFragmentSize() int32 {
	if x != nil {
		return x.DpiFragmentSize
	}
	return 0
}

func (x *Config) GetDpiFragmentDelay() int32 {
	if x != nil {
		return x.DpiFragmentDelay
	}
	return 0
}

func (x *Config) GetDpiRandomSize() bool {
	if x != nil {
		return x.DpiRandomSize
	}
	return false
}

func (x *Config) GetDpiMinSize() int32 {
	if x != nil {
		return x.DpiMinSize
	}
	return 0
...
func (x *Config) GetDpiMaxSize() int32 {
	if x != nil {
		return x.DpiMaxSize
	}
	return 0
...
const file_transport_internet_websocket_config_proto_rawDesc = "" +
	"\n" +
	")transport/internet/websocket/config.proto\x12!xray.transport.internet.websocket\"\x90\x04\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x0fheartbeatPeriod\x18\x06 \x01(\rR\x0fheartbeatPeriod\x12*\n" +
	"\x10dpiBypassEnabled\x18\a \x01(\bR\x10dpiBypassEnabled\x12(\n" +
	"\x0fdpiFragmentSize\x18\b \x01(\x05R\x0fdpiFragmentSize\x12*\n" +
	"\x10dpiFragmentDelay\x18\t \x01(\x05R\x10dpiFragmentDelay\x12$\n" +
	"\rdpiRandomSize\x18\n" +
	" \x01(\bR\rdpiRandomSize\x12\x1e\n" +
	"\n" +
	"dpiMinSize\x18\v \x01(\x05R\n" +
	"dpiMinSize\x12\x1e\n" +
	"\n" +
	"dpiMaxSize\x18\f \x01(\x05R\n" +
	"dpiMaxSize\x1a9\n" +
